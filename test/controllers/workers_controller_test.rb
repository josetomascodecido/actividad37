...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { email: @worker.email, last_name: @worker.last_name, name: @worker.name } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { email: @worker.email, last_name: @worker.last_name, name: @worker.name } }
